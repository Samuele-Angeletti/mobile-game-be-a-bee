...
public class UIPlayArea : MonoBehaviour, ISubscriber
{
    ...
    public void OnPublish(IMessage message)
    {
        ...
        {
            upDirectionButton.gameObject.SetActive(true);
            middleDirectionButton.gameObject.SetActive(true);
            lowDirectionButton.gameObject.SetActive(true);
    ...
    {
        middleDirectionButton.GetComponent<UIButtonAction>().LoadScenarioOnButton(_gameManager.CurrentScenario, false);
        switch (_gameManager.CurrentScenario)
        {
            case EScenario.Space:
                upDirectionButton.gameObject.SetActive(false);
                lowDirectionButton.GetComponent<UIButtonAction>().LoadScenarioOnButton(EScenario.Sky, false);
                break;
            case EScenario.Sky:
                upDirectionButton.GetComponent<UIButtonAction>().LoadScenarioOnButton(EScenario.Space, true);
                lowDirectionButton.GetComponent<UIButtonAction>().LoadScenarioOnButton(EScenario.Mountain, false);
                break;
            case EScenario.Mountain:
                upDirectionButton.GetComponent<UIButtonAction>().LoadScenarioOnButton(EScenario.Sky, true);
                lowDirectionButton.GetComponent<UIButtonAction>().LoadScenarioOnButton(EScenario.Forest, false);
                break;
            case EScenario.Forest:
                upDirectionButton.GetComponent<UIButtonAction>().LoadScenarioOnButton(EScenario.Mountain, true);
                lowDirectionButton.GetComponent<UIButtonAction>().LoadScenarioOnButton(EScenario.Underground, false);
                break;
            case EScenario.Underground:
                upDirectionButton.GetComponent<UIButtonAction>().LoadScenarioOnButton(EScenario.Forest, true);
                lowDirectionButton.gameObject.SetActive(false);
                break;
        }
    }
